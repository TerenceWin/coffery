...
// ── IMAGE UPLOAD HANDLER (disabled for study) ─────────────────────────────────
//
// To re-enable:
//   1. Restore imagesDir to MenuController struct in menuRouter.go
//   2. Add imagesDir string param back to RegisterMenuRoutes in menuRouter.go
//   3. Pass imagesDir when calling RegisterMenuRoutes in main.go
//   4. Uncomment router.Static and the imagesDir setup block in main.go
//   5. Uncomment router.POST("/upload-image", ctrl.UploadImage) in menuRouter.go
//   6. Uncomment everything below
//
// import (
// 	"crypto/rand"
// 	"encoding/hex"
